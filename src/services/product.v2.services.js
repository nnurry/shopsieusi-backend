...
const productRepo = require("../repositories/product.v2.repositories");
...
class ProductService {
    ...
    static async createProduct({ name, attributeNames, variants, images, categories }) {
        const res = await productRepo.createProduct({name, attributeNames, variants, images, categories});
        if (res.err != null) {
            return {
                status: status.INTERNAL_SERVER_ERROR,
                productId: null,
